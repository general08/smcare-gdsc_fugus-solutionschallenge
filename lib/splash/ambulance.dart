...
class _EmergencyDashboardState extends State<EmergencyDashboard> {
  ...
  Widget _buildHospitalList() {
    return ListView(
      children: <Widget>[
        _buildHospitalCard("Federal Medical Center,Gusau","+2348016913242", "26 July cordor"),
        _buildHospitalCard("Ahmad Sani Yariman Bakura","+234816913242", "26 July cordor"),
        _buildHospitalCard("King Fahad bn Abdulazez","+201116913242", "26 July cordor"),
      ],
      shrinkWrap: true,
    );
  }
