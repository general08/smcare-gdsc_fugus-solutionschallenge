    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          _buildMedicalHistoryCard(hospitalName: "FMC Gusau", appointmentDate: "19/02/18", medicalNote: "Mild Fever and Cold"),
          _buildMedicalHistoryCard(hospitalName: "UDUTH SOKOTO", appointmentDate: "19/02/18", medicalNote: "Dengue Fever detected. Low platelet count. Medicines include: ABC, XYZ"),
          _buildMedicalHistoryCard(hospitalName: "ABUTH Zaria", appointmentDate: "19/02/18", medicalNote: "Mild Fever and Cold"),
        ],
      ),
    );
  }
